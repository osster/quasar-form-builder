  ...
  data() {
    return {
      ...
      inputs: [
        ...
        { type: 'Checkbox', name: 'enable', label: 'active', col: 'col-md-3' },
        {
          type: 'separator',
          color: 'secondary  ',
          size: '3px',
        ...
        //   type: 'date',
        //   name: 'date_range',
        //   label: 'required date range with label',
        //   calendar: 'gregorian',
        //   range: true,
        //   col: 'col-md-6',
        //   rules: [(val) => (!!val.from && !!val.to) || 'field is required']
        // },
        {
          type: 'dateTime',
          name: 'creation_time_3',
          label: 'date & time',
          calendar: 'gregorian',
          col: 'col-md-6',
          todayBtn: true,
